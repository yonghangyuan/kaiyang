...
SEED_EVENTS: list[dict] = [
    ...
    {"start": "1931-01", "title": "传教士董笃宜注意到流散玉石", "desc": "英籍传教士董笃宜（V. H. Donnithorne）见流散玉器后联系华西协合大学博物馆，促成 1934 年发掘——外来者触发的考古链条。", "phase": "1929-1984", "imp": 1, "verify": "fact", "chain": "cause"},
    {"start": "1934-03", "title": "葛维汉主持首次发掘", "desc": "华西协合大学博物馆馆长葛维汉（D. C. Graham）在月亮湾燕家院子发掘 10 天，出土文物 600 余件；葛维汉判断其年代约当铜石并用时代至周初——科学考古起点。", "phase": "1929-1984", "imp": 2, "verify": "fact", "chain": "cause"},
    {"start": "1963-01", "title": "冯汉骥月亮湾发掘", "desc": "四川大学冯汉骥发掘月亮湾，提出「可能是古代蜀国都城中心」——首位把遗址与古蜀国联系的学者。", "phase": "1929-1984", "imp": 2, "verify": "fact", "chain": "cause"},
    {"start": "1980-05", "title": "三星堆遗址正式命名与系统发掘", "desc": "四川省文管会等在三星堆地点大规模发掘，1981 年简报首次以「三星堆遗址」命名；确认遗址范围逾 12 平方公里。", "phase": "1929-1984", "imp": 2, "verify": "fact", "chain": "cause"},
    # ── 阶段二 1986 两坑震撼 ──
    ...
    {"start": "1986-09", "title": "陈显丹提出「祭祀坑」说", "desc": "主持发掘的陈显丹等主张两坑为祭祀坑（而非墓葬/窖藏），埋藏行为与古蜀祭祀仪式相关——此后成为主流解释框架，但埋藏动因（改朝换代毁器？亡国掩埋？）至今存争议。", "phase": "1986", "imp": 2, "verify": "fact", "chain": "core"},
    ...
    {"start": "2021-03", "title": "黄金面具残片等首次直播发布", "desc": "央视直播 5 号坑半张黄金面具、青铜顶尊人像等 500 余件新出土文物，全网刷屏——三星堆重返公共视野中心。", "phase": "2019-2022", "imp": 3, "verify": "fact", "chain": "core"},
    {"start": "2021-05", "title": "碳十四测年锚定商代晚期", "desc": "测年把 3-8 号坑定为商代晚期（约公元前 1131-1012 年）；与殷墟武丁-帝辛时段相当——文献互认有了绝对年代锚点。", "phase": "2019-2022", "imp": 3, "verify": "fact", "chain": "core"},
    {"start": "2022-06", "title": "近完整黄金面具出土", "desc": "5 号坑修复出含金量约 85% 的近完整黄金面具（残片拼合，重约 280 克）；同坑丝织品残留证实丝绸存在。", "phase": "2019-2022", "imp": 2, "verify": "fact", "chain": "core"},
    {"start": "2022-09", "title": "龟背形网格状器公布", "desc": "7 号坑龟背形网格状器内嵌玉石器、捆绑痕迹清晰——形制前所未见，功能未解；器物持续挑战解读框架。", "phase": "2019-2022", "imp": 2, "verify": "fact", "chain": "core"},
